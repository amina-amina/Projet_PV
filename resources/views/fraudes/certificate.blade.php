...
@section('title', 'Employes Management System | ')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card my-5">
                ...
                <div class="card-body">
                    <p class="lead">
                        This is to certify that <b></b> is presently employed with me in the following :
                    </p>
                    <p class="lead">
                        <b>{{$employe->depart}}</b> departement.
                    </p>
                    <p class="lead">
                        Their employment began on <b></b>
                    </p>
                    <p class="lead">
                        This Certification is being issued upon the request of <b></b> for whatever legal purpose it may serve.
                    </p>
                    <p class="lead">
